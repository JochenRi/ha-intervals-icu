...
9 Familien · 18 Testdateien mit **5.324** gezählten Einzelprüfungen · 57 Releases.
...
**18 Dateien, 5.324 gezählte Einzelprüfungen, alle grün.** Kein Test braucht eine laufende
...
| **Gruß in der Panel-Überschrift WIEDER ENTFERNEN** | ⏳ **offen, und zwar mit Ablaufdatum.** In der Kopfzeile steht „Guten Morgen Michael ♥" — ein EINMALIGER Gruß an Michael, von dem das Trainingswissen hinter diesem Projekt stammt und der sich die App ansehen wollte. Er ist als eigener Commit gesetzt (`Gruss an Michael`), damit er sich sauber zurückdrehen lässt: `git revert` genügt, eine Zeile in `intervals-panel.js`. **Beim nächsten Release entfernen.** Ohne diesen Eintrag stünde er in vier Wochen noch da, ohne dass jemand weiß warum |
