...
**Stand:** 16.09.2026 · **Version:** 0.57.0 · **Status:** produktiv auf HEIMDALL,
...
9 Familien · 21 Testdateien mit **6.726** gezählten Einzelprüfungen · 62 Releases.
...
**21 Dateien, 6.726 gezählte Einzelprüfungen, alle grün.** Kein Test braucht eine laufende
...
| `test_handlers.py` | Handler am ECHTEN Aufruf, HA gestubbt: **der Schreibweg nach Intervals rechnet über `scaled()` und schreibt absolute Watt — über den ganzen Katalog, mit Trefferzusicherung für Blöcke, Kurve und FTP; ohne Wattzahlen wird nicht geschrieben**; der Kurvensatz folgt der Schalterstellung; jeder Grund der markierten Auswahl hat ein Wort ; die Verwerfungssätze reisen aus dem Modul | 60 |
