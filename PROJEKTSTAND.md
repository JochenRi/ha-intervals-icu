...
**Stand:** 24.09.2026 · **Version:** 0.67.2 · **Status:** produktiv auf HEIMDALL,
...
9 Familien · 24 Testdateien mit **7.947** gezählten Einzelprüfungen · 84 Releases.
...
**24 Dateien, 7.947 gezählte Einzelprüfungen, alle grün.** Kein Test braucht eine laufende
...
| `test_analytics.py` | Trainingsmetriken gegen bekannte Ergebnisse, Ebene-3-Wächter (Last kennt keine Etiketten, Quelltext und Verhalten), **die Wochenbilanz aus dem Archiv — Abgrenzung, und dass nichts gepaart wird** ; **seit 0.67.2 (S2) ist die Kalender-Wochenlast die Summe der Tageslasten aus `load_by_day`, mit Fixture-Beweis gegen die Aktivitätssumme** | 109 |
