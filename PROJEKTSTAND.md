...
9 Familien · 22 Testdateien mit **7.147** gezählten Einzelprüfungen · 66 Releases.
...
**22 Dateien, 7.147 gezählte Einzelprüfungen, alle grün.** Kein Test braucht eine laufende
...
| `test_projektstand.py` | die Tabelle unter diesem Absatz gegen einen echten Suite-Lauf: jede Zeile einzeln, Dateien ohne gemeldete Zahl, Kopfzeile und Einleitungssatz; **die eigene Zeile gegen den eigenen Zähler** | 79 |
