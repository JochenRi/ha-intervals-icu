...
**Stand:** 15.09.2026 · **Version:** 0.56.0 · **Status:** produktiv auf HEIMDALL,
...
9 Familien · 20 Testdateien mit **6.484** gezählten Einzelprüfungen · 60 Releases.
...
**20 Dateien, 6.484 gezählte Einzelprüfungen, alle grün.** Kein Test braucht eine laufende
...
| **Der Kurvenschalter (Paket P/B, B2b-1)** | ✅ gebaut als **0.56.0**. Reiter **Quellen**: beide Schalter nebeneinander, gruppiert unter „Woher die Zahlen kommen", mit den Zahlen BEIDER Stellungen (`plan_other`, in der Payload gerechnet), dem Satz über die geänderte Leserichtung und der Sperre am Blockschalter samt ihrem GRUND — die Grundlagenkette liefert die Schwellenzahl, die das Pulsfenster der Blockfamilien steuert. Der Schalter steht im ARCHIV (`settings.curve_from_marks`), nicht in den Integrationsoptionen, und speichert nur im Änderungsfall. Umgelegt liest `fatigue.rides()` nur markierte UND gemessene Grundlagen-Fahrten; `fatigue_curve_reason` und `above_endurance_share` bleiben als Rückfall für die Aus-Stellung stehen — ein Bauteil, nicht zwei. Der Rückweg ist mit drei Prüfungen BELEGT (gleiche Auswahl, gleiche Ausschlüsse, unberührter Bestand). §7, neunundzwanzigster und dreißigster Fall. Verifikation am System steht aus |
