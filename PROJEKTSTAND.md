...
9 Familien · 21 Testdateien mit **7.046** gezählten Einzelprüfungen · 65 Releases.
...
**21 Dateien, 7.046 gezählte Einzelprüfungen, alle grün.** Kein Test braucht eine laufende
...
| `test_import.py` | vollständiger Import gegen einen Nachbau des Kontos, Schwellenreihe und `since`, day_context-Migration und Schreibweg, Quellenblock-Auflagen, **der Versionsmarken-Wächter mit Gegenprobe über eine dritte Marke, der Historienbeginn getrennt vom Bestandszeitraum** | 127 |
