# Journal „Nächster Chat" — Altbestand bis 0.69.0

> **Momentaufnahme.** Dies ist der komplette Inhalt von `NAECHSTER_CHAT.md` bis zum 25.09.2026
> (0.69.0), unverändert übernommen bis auf drei Vermerke (Auslieferung/Token, Suite-Aufruf).
> **Nichts hierin ist Anleitung oder Stand.** Stand: `PROJEKTSTAND.md`. Jeder Abschnitt gilt
> für die Version in seiner Überschrift; „AKTUELL"/„Zuerst lesen"/„OFFEN" beziehen sich auf die
> jeweilige Version, nicht auf heute. Zahlen (Zeilen, Prüfungen, FTP, Vorgaben) sind Messungen
> vom jeweiligen Datum.
...
> **Ungültig seit 25.09.2026, neuer Ablauf wird am Rechner geklärt.** Der Auslieferungs-,
> Push- und Release-Ablauf dieses Abschnitts (Token aus `GIT_Intervals.txt`, `x-access-token`
> in der URL, Release per API) gilt nicht mehr als Anleitung; siehe PROJEKTSTAND §11, Vermerk.
...
> **Klon-/Token-Zeilen ungültig seit 25.09.2026** (siehe 4.3). **Suite-Schleife: `python3` ist
> hier falsch — `python3.13` verwenden, Voraussetzung Python ≥ 3.12 (PROJEKTSTAND §9, Aufruf).**
...
- **Token (ungültig seit 25.09.2026, wird am Rechner geklärt):** liegt als `GIT_Intervals.txt` bei, bleibt in einer Shell-Variablen,
