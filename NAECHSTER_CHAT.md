...
**Stand:** 25.09.2026 · **Version:** 0.69.2 · Prüfstand **24 / 8.174 / 0** (python3.13 + node)
...
- Vorlage V1 (0.69.2): Block „5“ von `vo2_5x4` fällt auf die FTP (Etikettregel endet bei „4“) — Versehen oder gewollt?
