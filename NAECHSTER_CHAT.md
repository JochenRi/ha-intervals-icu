...
**Stand:** 26.09.2026 · **Version:** 0.73.0 · Prüfstand **24 / 8.821 / 0** (python3.13 + node)
...
2. `PROJEKTSTAND.md` §7, Fälle 58–70: was 0.68.0–0.73.0 geändert hat.
3. `docs/rechenwege.md` K5 (Umkehrung, mit Nachträgen 0.67.0/0.68.0) — nur wenn es um die Kachel oder die Grundlagen-Watt geht.

## Prüfstand
`bash tests/run_all.sh` (aus dem Repo-Wurzelverzeichnis; nimmt `python3.13`, dazu `node`). Ende: `Dateien=24 Summe=8821 Fehler=0`.
...
- Zur Prüfung (0.72.0): Beleg-Kennung Stufentest „Studie“ und Wiedereinstieg „Konvention“ — nicht in der Tabelle der Skizze.
