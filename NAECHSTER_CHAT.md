...
**Stand:** 26.09.2026 · **Version:** 0.73.1 · Prüfstand **24 / 8.870 / 0** (python3.13 + node)
...
2. `PROJEKTSTAND.md` §7, Fälle 58–71: was 0.68.0–0.73.1 geändert hat.
3. `docs/rechenwege.md` K5 (Umkehrung, mit Nachträgen 0.67.0/0.68.0) — nur wenn es um die Kachel oder die Grundlagen-Watt geht.

## Prüfstand
`bash tests/run_all.sh` (aus dem Repo-Wurzelverzeichnis; nimmt `python3.13`, dazu `node`). Ende: `Dateien=24 Summe=8870 Fehler=0`.
