...
**Stand:** 25.09.2026 · **Version:** 0.70.0 · Prüfstand **24 / 8.296 / 0** (python3.13 + node)
...
2. `PROJEKTSTAND.md` §7, Fälle 58–64: was 0.68.0–0.70.0 an Zahlen bewegt haben.
3. `docs/rechenwege.md` K5 (Umkehrung, mit Nachträgen 0.67.0/0.68.0) — nur wenn es um die Kachel oder die Grundlagen-Watt geht.

## Prüfstand
`bash tests/run_all.sh` (aus dem Repo-Wurzelverzeichnis; nimmt `python3.13`, dazu `node`). Ende: `Dateien=24 Summe=8296 Fehler=0`.
...
- Befund nebenbei (0.70.0): Grundlagen-Herkunftsabsatz `_gaText` ohne `<span>` im Flex-Absatz, zerfällt optisch.
