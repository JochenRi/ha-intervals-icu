...
function fatigue(over) {
  ...
  return Object.assign({
    ...
    dropped: {
      ...
      no_dfa: [{ activity_id: "a4", date: "2025-12-13", name: "Entkopplungs-Test #5", above_z2: 1.1, minutes: 186 },
               { activity_id: "a5", date: "2025-11-30", name: "Low Stress Base #18", above_z2: 2.0, minutes: 158 }],
    },
    dropped_counts: { structured: 2, short: 1, no_dfa: 45 },
    ...
    aerobic_hr: 160, aerobic_power: 146, hr_drift_per_hour_pct: 3.17,
    paired: [{ from_hour: 1, to_hour: 2, delta: -10.1, n: 9, enough: true },
             { from_hour: 2, to_hour: 3, delta: -4.2, n: 5, enough: false }],
    occupancy_rising: [], min_pairs: 6,
